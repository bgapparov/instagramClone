...
//  InstagramFirstore
//
//  Created by Baiaman Gapparov on 11/26/20.
//
...
class FeedCell: UICollectionViewCell {
    ...
    private lazy var usernameButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(didPressUserNameButton), for: .touchUpInside)
        return button
    }()
    ...
    private let captionLabel: UILabel = {
       let label = UILabel()
        label.text = "Here is Some captions now..."
    ...
    @objc func didPressUserNameButton() {
